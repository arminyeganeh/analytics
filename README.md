...
This is a three-credit class that can be taken for an ordinal grade or pass/fail depending on the individual program requirements. The instructor does not have control over the grading option by which learners are evaluated. To change your grading option, learners should contact the registrar’s office and/or the program coordinator. The minimum cumulative grade-point average required for graduation is 3.0 for graduate students.
